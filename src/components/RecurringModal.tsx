      ...
      >
        <div className="modal-header">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <h2>{initialExpense ? '[EDIT_RECURRENCE_RULE]' : '[NEW_RECURRENCE_RULE]'}</h2>
            <button 
              onClick={onClose}
            ...
            */}
            <div style={{ 
              ...
              gap: '8px'
               ...
               <span style={{ color: 'var(--color-text-muted)', fontSize: '10px', fontFamily: 'var(--font-mono)' }}>[DATA_PREVIEW_MODULE_OFFLINE]</span>
               <p style={{ color: 'var(--color-text-muted)', fontSize: '10px', textAlign: 'center', maxWidth: '300px' }}>
                 O modo de visualização em tempo real das transações correspondentes será implementado em breve.
               </p>
            </div>
          </div>
